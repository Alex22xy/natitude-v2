    ...
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full px-4 max-w-[450px]">
      <div className="bg-black/80 backdrop-blur-xl border border-white/5 px-6 py-3 rounded-[32px] flex justify-between items-center shadow-2xl">
        ...
        <a href="#events" className="flex flex-col items-center gap-1 group">
          ...
          <span className="text-[9px] uppercase font-medium text-zinc-500 group-hover:text-white transition-colors">Ritual</span>
        </a>

        {/* THE FEATURED JOIN BUTTON */}
        ...
        {/* HIDDEN ADMIN TRIGGER: This icon is invisible but clickable for you */}
        <a href="/admin" className="flex flex-col items-center gap-1 opacity-0 pointer-events-auto cursor-default">
