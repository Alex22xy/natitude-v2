    ...
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full px-4 max-w-[450px]">
      <div className="bg-black/80 backdrop-blur-xl border border-white/5 px-6 py-3 rounded-[32px] flex justify-between items-center shadow-2xl">
        ...
        <a href="#home" className="flex flex-col items-center gap-1 group">
          ...
          <span className="text-[9px] uppercase font-medium text-zinc-500 group-hover:text-white transition-colors">Home</span>
        </a>
        ...
        <a href="#events" className="flex flex-col items-center gap-1 group">
          ...
          <span className="text-[9px] uppercase font-medium text-zinc-500 group-hover:text-white transition-colors">Events</span>
        </a>

        {/* THE FEATURED JOIN BUTTON - PINK EDITION */}
        ...
        <a href="#home" className="flex flex-col items-center gap-1 group">
          ...
          <span className="text-[9px] uppercase font-medium text-zinc-500 group-hover:text-white transition-colors">Archive</span>
        </a>

        {/* Admin */}
        <a href="/admin" className="flex flex-col items-center gap-1 group">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-zinc-500 group-hover:text-[#FF007F] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          <span className="text-[9px] uppercase font-medium text-zinc-500 group-hover:text-[#FF007F] transition-colors">Admin</span>
        </a>
